...
public:
	...
	virtual void calc(vector<Player>& players) override
	{
		...
		tempScore[2] = 0.5;
		if ((optionCount[0] + optionCount[1]) / optionCount[3] >= 2) {
			tempScore[3] = 3;
		}
	}
};
...
public:
	...
	virtual void calc(vector<Player>& players) override
	{
		...
		tempScore[2] = 1;
		tempScore[3] = -2;
		bool is_ban = optionCount[2] > optionCount[1];
		if (is_ban) {
			tempScore[0] = 0;
			tempScore[1] = -1;
			tempScore[3] = 2;
...
public:
	...
	virtual void initTexts(vector<Player>& players) override
	{
		texts.push_back("选择一项，人数最多的一项额外-1分（如有并列则一起减）");
	}
	virtual void initOptions() override
	{
        options.push_back("+0.5");
...
public:
	...
	virtual void calc(vector<Player>& players) override
	{
		...
		if (optionCount[0] && optionCount[1] && optionCount[2]) {
			tempScore[3] = 4;
		}
	}
};
...
class Q62 : public Question   // 修复 1
{
public:
	Q62()
	{
	...
	virtual void initOptions() override
	{
		...
		options.push_back("九种九牌：-4，如果任何人选择此项，则使其他选项无效；如果有人选择C，此选项分数改为+2");
...
class Q64 : public Question   // 备选题目
{
public:
	Q64()
	{
...
class Q66 : public Question   // 备选题目
{
public:
	Q66()
	{
...
class Q67 : public Question   // 备选题目
{
public:
	Q67()
	{
...
class Q69 : public Question   // 平衡 1
{
public:
	Q69()
	{
...
class Q71 : public Question   // 平衡 4   备选题目
{
public:
	Q71()
	{
...
class Q74 : public Question   // 平衡 1
{
public:
	Q74()
	{
...
class Q75 : public Question   // 平衡 1
{
public:
	Q75()
	{
...
class Q79 : public Question   // 平衡 1
{
public:
	Q79()
	{
...
class Q80 : public Question   // 备选题目
{
public:
	Q80()
	{
	...
	virtual void initOptions() override
	{
		vars["num"] = playerNum > 26 ? 26 : playerNum;
...
class Q88 : public Question   // 备选题目
{
public:
	Q88()
	{
...
class Q89 : public Question   // 平衡 1
{
public:
	Q89()
	{
...
public:
	...
	virtual void initTexts(vector<Player>& players) override
	{
		texts.push_back("只有一个玩家选择的最小选项+3。若有两个以上的玩家选择同一选项，扣除等同于该选项人数的分。");
	}
	virtual void initOptions() override
	{
		if (playerNum < 5) {
	...
	virtual void calc(vector<Player>& players) override
	{
		...
		for (int i = 0; i < vars["num"]; i++) {
			...
			if (optionCount[i] > 2) {
				tempScore[i] = -optionCount[i];
			}
		}
	}
};

class Q92 : public Question   // 平衡 1
{
public:
	Q92()
	{
...
class Q93 : public Question   // 备选题目
{
public:
	Q93()
	{
...
public:
	...
	virtual void initOptions() override
	{
		options.push_back("高考：选择本选项的玩家其中一个+5，其他-1");
	...
	virtual void calc(vector<Player>& players) override
	{
		int win = rand() % int(optionCount[0]);
		int current = 0;
		for(int i = 0; i < playerNum; i++) {
			if (players[i].select == 0) {
				if (current == win) {
...
class Q98 : public Question   // 平衡 1   备选题目
{
public:
	Q98()
	{
	...
	virtual void initTexts(vector<Player>& players) override
	{
		texts.push_back("获取：可以获得等量的分数，但如果被抢夺，分值会变为相反数");
		texts.push_back("抢夺：如果有人获取相同的分数，即抢夺成功，获得抢夺的分数。抢夺失败失去等量的分数");
	}
	virtual void initOptions() override
	{
...
class Q103: public Question   // 备选题目
{
public:
	Q103()
	{
